...
function Division() {
  ...
  return (
    <View >
    <GoHome />
    <StyledText bold primary style={{fontSize: 40, marginVertical: 10}}>División</StyledText>
    <StyledText secondary style={{fontSize: 16}}>Ingrese 2 valores para realizar la división</StyledText>
